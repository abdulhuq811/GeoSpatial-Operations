...
public final class Point2D implements Comparable<Point2D>, Serializable {
    ...
    /**
     * Returns a comparison of two points based on x and y
     * @return an integer: 0 for equal, 1 for greater than, and -1 for less than
     */
    public int comparison(Point2D point) {
    	if(this.x > point.x) {
			return 1;
